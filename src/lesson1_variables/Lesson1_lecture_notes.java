...
public class Lesson1_lecture_notes {
    ...
    public static void main(String[] args) {
        ...
        int a, c;
//       НО! локальные переменные (в отличии от элементов массива) не инициализируются по умолчанию. Во избежания ошибок при компеляции они должны должны быть инициализированы явно (т.е. им должны быть присвоены значения).
//       a = a + c; - вот здесь будет ошибка, так как выше мы не проинициализировали эти переменные.
