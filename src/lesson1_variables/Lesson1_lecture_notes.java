...
// объявление нового класса, где модификатор public указывает, что метод будет доступен из любого места программы,
// затем идёт ключевое слово class, затем название класса и тело самого класса в фигурных скобках
public class Lesson1_lecture_notes {
    ...
    // метод тоже имеет модефикатор public, static указывает, что метод статический, а void, что он не возвращает никакого значения
